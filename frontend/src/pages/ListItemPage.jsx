  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      const newItem = addListing({
        ...
        images: [finalImage, ...additionalImages],
        ownerName: user.name,
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 pt-4 border-t border-slate-100 dark:border-slate-800">
              ...
              <div className="p-4 border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-2xl text-center bg-slate-50/50 dark:bg-slate-800/40 hover:bg-slate-100/80 transition cursor-pointer relative group">
                <input
                  type="file"
                  multiple
                  accept="image/*"
              ...
              <div className="flex gap-2 mt-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-sm font-medium text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-blue-500"
                />
                <button
                  type="button"
                  onClick={() => {
